...
const Sidenav = () => {
    ...
    return (
        <React.Fragment>
            <div className='absolute shadow-md w-96 h-full mt-1 z-40'>
                ...
                <div>
                    <span className='w-full hover:bg-blue-100 my-8 font-mono text-sm py-2'><Link to="/"><FontAwesomeIcon className='text-blue-200 mx-10' icon={faUser} />Manual Settlement</Link></span>
                </div>
            </div>
        </React.Fragment>
    )
